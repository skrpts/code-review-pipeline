...
Generates a comprehensive security report from the security scanning findings. Intended for security-conscious teams that need more detail than what appears in the general review summary.
